            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form id="editProductForm" action="{{ route('update-product', $productData->id) }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="old_img" value="{{ $productData->image }}">
                            <input type="hidden" id="pro_subcat_selected_value"
                                value="{{ $productData->pro_subcat_id}}">
                            <div class="card-body">
                                ...
                                <div class=" form-group">
                                    ...
                                    <input type="text" class="form-control" id="title" name="product_name"
                                        value="{{$productData->product_name}}" placeholder="Enter Title">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="productcode" name="product_code"
                                        value="{{$productData->product_code}}" placeholder="Enter Product Code">
                                </div>
                                ...
                                <div class="row col-md-12">
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <div id="imagePreview" class="mt-2"
                                            ...
                                            <img src="{{ asset('product-images/' . $productData->image) }}"
                                    ...
                                    <div class="form-group col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title_tag"
                                            value="{{$productData->title_tag}}" placeholder="Enter Title">
                                    </div>

                                    <div class="form-group col-md-4 mb-3">
                                        <label for="text">Image alt tag</label>
                                        <input type="text" class="form-control" id="title" name="alt_tag"
                                            value="{{$productData->alt_tag}}" placeholder="Enter Title">
                                    </div>
                                </div>
