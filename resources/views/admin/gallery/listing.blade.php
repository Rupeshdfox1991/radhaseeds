...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Image Gallery Listing</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Image Gallery Listing</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Image Gallery Listing</h3>
                            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{ asset('gallery-images/' . $value->images) }}"
                                                alt="Product Images" style="height: 30px; width: 30px;">
                                        </td>
                                        <td>{{ $value->created_at }}</td>
                                        <td class="project-state">
                                            <!-- <span class="badge badge-success">Success</span> -->
                                            <a href="{{ route('changegallerycatstatus', ['id' => $value->id, 'status' => $value->is_active == 1 ? 0 : 1]) }}"
                                                class="btn btn-sm btn-{{ $value->is_active == 1 ? 'danger' : 'success' }}">{{ $value->is_active == 1 ? 'Deactivate' : 'Activate' }}</a>
                                        </td>
                                        <td class="project-actions text-left">

                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('edit-gallery', $value->id) }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="{{ route('delete-gallery', ['id' => $value->id, 'status' => 2]) }}"
