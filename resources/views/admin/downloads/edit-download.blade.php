          ...
          <div class="col-md-10">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Download Details</h3>
              </div>
              @if($errors->any())
              ...
              <form action="{{ route('admin.downloads.update', ['download' => $download->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <input type="hidden" name="old_file" value="{{ $download->doc_file }}">
                <div class="card-body">
                  <div class="form-group">
                    <label for="text">Title</label>
                    <input type="text" class="form-control" value="{{ $download->name }}" id="name" name="name" placeholder="Enter Title">
                  </div>
                  ...
                  <!-- <div class="form-group">
                    ...
                    <div id="uploadedFileName" class="mt-2">
                      <a href="{{ asset('downloads/' . $download->doc_file) }}" target="_blank">
                        <img src="{{ asset('file-icon.png') }}" style="height: 50px; width: 50px;" class="img-fluid" alt="PDF Icon">
                        <p>PDF Name: {{ $download->doc_file }}</p>
                      </a>
                    </div>                  
                  </div> -->
                  ...
                  <div class="form-group col-md-4 mb-3">
                      ...
                      <div class="input-group">
                          <div class="custom-file">
                              <input type="file" class="custom-file-input" id="exampleInputFile" name="doc_file" onchange="previewImage1(this);">
                              <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                          </div>
                          <div class="input-group-append">
                              <span class="input-group-text">Upload</span>
                      ...
                      <div id="imagePreview1" class="mt-2" style="height: 100px; width: auto; border: 1px solid #ccc; padding: 4px;"><img src="{{ asset('downloads/' . $download->doc_file) }}" class="img-fluid" alt="Preview">
                      </div>
                  </div>

                  <div class="form-group">
                    <label for="text">Banner Link</label>
                    <input type="text" class="form-control" value="{{ $download->external_link }}" name="external_link" id="title" placeholder="Enter Title">
                  </div>                  
                  <!-- <div class="form-group">
    ...
    function updateFileName() {
        ...
        if (fileInput.files.length > 0) {
            ...
            if (fileSizeInMB <= 20) {
                ...
                fileNameContainer.textContent = 'File size exceeds 20MB. Please choose a smaller file.';
            }
        } else {
