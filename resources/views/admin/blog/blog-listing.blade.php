                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-state">
                                            ...
                                            <a href="{{ route('admin_change_blog_status', ['id' => $blog->id, 'status' => $blog->is_active == 1 ? 0 : 1]) }}"
                                                class="btn btn-sm btn-{{ $blog->is_active == 1 ? 'danger' : 'success' }}">{{ $blog->is_active == 1 ? 'Deactivate' : 'Activate' }}</a>
                                        </td>
                                        <td class="project-actions text-left">
                                            ...
                                            <!-- <a class="btn btn-danger btn-sm"
                                                    href="{{ route('admin_blog_delete', ['id' => $blog->id, 'status' => 2]) }}">
                                            ...
                                            <a class="btn btn-danger btn-sm" href="#" data-toggle="modal"
                                                data-target="#deleteConfirmationModal{{$blog->id}}">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>

                                            <!-- Delete Confirmation Modal -->
                                            <div class="modal fade" id="deleteConfirmationModal{{$blog->id}}"
                                                tabindex="-1" role="dialog"
                                                aria-labelledby="deleteConfirmationModalLabel{{$blog->id}}"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                id="deleteConfirmationModalLabel{{$blog->id}}">
                                                                Confirm Deletion</h5>
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="{{ route('admin_blog_delete', ['id' => $blog->id, 'status' => 2]) }}"
